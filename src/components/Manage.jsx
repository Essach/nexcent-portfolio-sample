...
const Manage = () => {
    return (
        <Flex direction={'column'} w='100%' justify={'center'} align={'center'} px={['72px', '72px', '72px', '144px']} py='40px'>
            <Heading color='brandD_Grey' fontSize={['lg', '2xl', '3xl']} w='45%' textAlign={'center'}>Manage your entire community in a single system</Heading>
            <Text mt='5px' color='brandGrey' fontSize={['md', 'lg']}>Who is Nexcent suitable for?
            </Text>
            <Flex mt='18px' w='100%' justify={'space-around'}>
                <Box w={['100px', '150px', '300px']} display={'flex'} flexDirection='column' alignItems={'center'} justifyContent={'center'} boxShadow={'sm'} p='24px 32px'>
                    <Image src={image1} />
