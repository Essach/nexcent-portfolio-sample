...
const Section8 = () => {
    return (
        <Flex px={['72px', '72px', '72px', '144px']} w='100%' direction={'column'} alignItems={'center'}>
            ...
            <Text textAlign={'center'} width='50%' color='brandGrey' fontSize={['md', 'lg']} mt='16px'>{`The Nexcent blog is the best place to read about the latest membership insights, trends and more. See who's joining the community, read about how our community are increasing their membership income and lot's more.`}</Text>
            <SimpleGrid mt='16px' columns={3} gap='35px'>
