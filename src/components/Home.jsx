...
const Home = () => {
    return (
        <Grid templateColumns='7fr 5fr' px={['72px', '72px', '72px', '144px']} bg='brandSilver' flexGrow={1} alignItems={'center'}>
            <Box>
                <Box>
                    <Box>
            ...
            <Flex justifyContent={'start'}>
                <Image src={illustration} flexGrow={1} />
            </Flex>
            <GridItem colSpan={2} display={'flex'} justifyContent={'center'} h='100%' alignItems={'end'} pb='25px'>
                <Flex gap='10px'>
